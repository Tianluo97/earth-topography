declare module "gui" {
  ...
  export class Image {
    ...
    resize(newSize: SizeF, scaleFactor: number): Image;
    toPNG(): any;
    toJPEG(quality: number): any;
  }
  ...
  export interface GlobalShortcut {
    register(accelerator: string, callback: Function): number;
  ...
  export type TableColumnType = "text" | "edit" | "checkbox" | "custom";
